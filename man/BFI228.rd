...
\alias{BFI228}
\docType{data}
\title{Ordinal Data of the Big Five Inventory (BFI)
}

\description{
The BFI228 is part of the study on personality and relationship satisfication (Luo, 2005).  The participants were 228 undergraduate students at a large public unverisity in the US.  The data were participants' self ratings on the 44 items of the Big Five Inventory (John, Donahue, & kentle, 1991). These items are Likert variables: disagree strongly (1), disagree a little (2), neither agree nor diagree (3), agree a little (4), and agree strongly (5).  
